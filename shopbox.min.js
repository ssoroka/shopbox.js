...
0?"image":a.match(/^https?\:\/\/\S+$/)?"iframe":"content"};return b}();window.ShopBox=c;jQuery.fn.shopbox=function(b,a){var d;a==null&&(a={});d=this;c.init();return d.click(function(e){e.preventDefault();c.setContent(c.getContent(b,a,d));return c.show()})};jQuery.fn.transitionEnd=function(b){return this.one("TransitionEnd webkitTransitionEnd transitionend oTransitionEnd",b)}}).call(this);
